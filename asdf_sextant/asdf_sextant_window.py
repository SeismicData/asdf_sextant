...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.waveform_vertical_splitter.setObjectName(u"waveform_vertical_splitter")
        ...
        self.close_file_button.setObjectName(u"close_file_button")
        ...
        self.open_files_list_widget.setObjectName(u"open_files_list_widget")
        ...
        self.waveform_left_side_splitter.setObjectName(u"waveform_left_side_splitter")
        ...
        self.station_view.setObjectName(u"station_view")
        ...
        self.web_engine_view.setProperty("url", QUrl(u"about:blank"))
        ...
        self.reset_view_push_button.setObjectName(u"reset_view_push_button")
        ...
        self.detrend_and_demean_check_box.setObjectName(u"detrend_and_demean_check_box")

        self.horizontalLayout_2.addWidget(self.detrend_and_demean_check_box)

        self.normalize_check_box = QCheckBox(self.layoutWidget1)
        self.normalize_check_box.setObjectName(u"normalize_check_box")
        ...
        self.custom_processing_check_box.setObjectName(u"custom_processing_check_box")
        ...
        self.custom_processing_push_button.setObjectName(u"custom_processing_push_button")
        ...
        self.references_push_button.setObjectName(u"references_push_button")
        ...
        self.central_tab.setTabText(self.central_tab.indexOf(self.waveform_tab), u"Waveforms")
        self.auxiliary_data_tab = QWidget()
        self.auxiliary_data_tab.setObjectName(u"auxiliary_data_tab")
        ...
        self.auxiliary_data_tree_view.setObjectName(u"auxiliary_data_tree_view")
        ...
        self.auxiliary_data_stacked_widget = QStackedWidget(self.auxiliary_data_tab)
        self.auxiliary_data_stacked_widget.setObjectName(u"auxiliary_data_stacked_widget")
        self.auxiliary_data_graph_page = QWidget()
        self.auxiliary_data_graph_page.setObjectName(u"auxiliary_data_graph_page")
        ...
        self.auxiliary_data_graph.setObjectName(u"auxiliary_data_graph")
        sizePolicy1.setHeightForWidth(self.auxiliary_data_graph.sizePolicy().hasHeightForWidth())
        ...
        self.auxiliary_data_file_page.setObjectName(u"auxiliary_data_file_page")
        self.horizontalLayout_9 = QHBoxLayout(self.auxiliary_data_file_page)
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.auxiliary_file_browser = QTextBrowser(self.auxiliary_data_file_page)
        self.auxiliary_file_browser.setObjectName(u"auxiliary_file_browser")
        font2 = QFont()
        font2.setFamily(u"Andale Mono")
        ...
        self.show_auxiliary_provenance_button = QPushButton(self.auxiliary_data_tab)
        self.show_auxiliary_provenance_button.setObjectName(u"show_auxiliary_provenance_button")
        ...
        self.auxiliary_data_info_table_view.setObjectName(u"auxiliary_data_info_table_view")
        self.auxiliary_data_info_table_view.horizontalHeader().setProperty("showSortIndicator", False)
        ...
        self.auxiliary_data_detail_table_view.setObjectName(u"auxiliary_data_detail_table_view")
        ...
        self.provenance_tab.setObjectName(u"provenance_tab")
        ...
        self.provenance_list_view.setObjectName(u"provenance_list_view")
        ...
        self.provenance_graphics_view.setObjectName(u"provenance_graphics_view")
        ...
        self.event_tree_widget.setObjectName(u"event_tree_widget")
        ...
        self.events_web_engine_view.setObjectName(u"events_web_engine_view")
        self.events_web_engine_view.setProperty("url", QUrl(u"about:blank"))

        self.verticalLayout_5.addWidget(self.events_web_engine_view)

        self.events_text_browser = QTextBrowser(self.event_tab)
        self.events_text_browser.setObjectName(u"events_text_browser")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"ASDF Sextant", None))
        self.select_file_button.setText(QCoreApplication.translate("MainWindow", u"Open File", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Or just drag & drop an ASDF file into this window", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Open Files", None))
        self.close_file_button.setText(QCoreApplication.translate("MainWindow", u"Close File", None))
        self.reset_view_push_button.setText(QCoreApplication.translate("MainWindow", u"Reset View", None))
        self.detrend_and_demean_check_box.setText(QCoreApplication.translate("MainWindow", u"Detrend and Demean", None))
        self.normalize_check_box.setText(QCoreApplication.translate("MainWindow", u"Normalize", None))
        self.custom_processing_check_box.setText("")
        self.custom_processing_push_button.setText(QCoreApplication.translate("MainWindow", u"Custom Processing", None))
        self.references_push_button.setText(QCoreApplication.translate("MainWindow", u"References", None))
...
#endif // QT_CONFIG(tooltip)
        self.show_auxiliary_provenance_button.setText(QCoreApplication.translate("MainWindow", u"Show Provenance", None))
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Data Information", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Parameters", None))
        self.central_tab.setTabText(self.central_tab.indexOf(self.auxiliary_data_tab), QCoreApplication.translate("MainWindow", u"Auxiliary Data", None))
        self.central_tab.setTabText(self.central_tab.indexOf(self.provenance_tab), QCoreApplication.translate("MainWindow", u"Provenance", None))
        self.central_tab.setTabText(self.central_tab.indexOf(self.event_tab), QCoreApplication.translate("MainWindow", u"Events", None))
    # retranslateUi
