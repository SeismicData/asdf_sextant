...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.waveform_vertical_splitter.setObjectName(_fromUtf8("waveform_vertical_splitter"))
        self.widget = QtGui.QWidget(self.waveform_vertical_splitter)
        ...
        self.close_file_button = QtGui.QPushButton(self.widget)
        ...
        self.open_files_list_widget = QtGui.QListWidget(self.widget)
        self.open_files_list_widget.setMinimumSize(QtCore.QSize(0, 125))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.open_files_list_widget.setFont(font)
        self.open_files_list_widget.setObjectName(_fromUtf8("open_files_list_widget"))
        self.verticalLayout_3.addWidget(self.open_files_list_widget)
        self.waveform_left_side_splitter = QtGui.QSplitter(self.widget)
        self.waveform_left_side_splitter.setOrientation(QtCore.Qt.Vertical)
        self.waveform_left_side_splitter.setObjectName(_fromUtf8("waveform_left_side_splitter"))
        ...
        self.widget1 = QtGui.QWidget(self.waveform_vertical_splitter)
        self.widget1.setObjectName(_fromUtf8("widget1"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.widget1)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.reset_view_push_button = QtGui.QPushButton(self.widget1)
        ...
        self.detrend_and_demean_check_box = QtGui.QCheckBox(self.widget1)
        ...
        self.normalize_check_box = QtGui.QCheckBox(self.widget1)
        ...
        self.references_push_button = QtGui.QPushButton(self.widget1)
        ...
        self.graph = GraphicsLayoutWidget(self.widget1)
        ...
        self.events_web_view.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Or just drag & drop an ASDF file into this window", None))
        self.label_2.setText(_translate("MainWindow", "Open Files", None))
        self.close_file_button.setText(_translate("MainWindow", "Close File", None))
