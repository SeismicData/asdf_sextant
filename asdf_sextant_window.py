...
# Form implementation generated from reading ui file '/home/obsuser/PycharmProjects/asdf_sextant/asdf_sextant_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.continuous_check_box = QtGui.QCheckBox(self.centralwidget)
        self.continuous_check_box.setObjectName(_fromUtf8("continuous_check_box"))
        self.horizontalLayout.addWidget(self.continuous_check_box)
        ...
        self.station_view.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        ...
        self.openASDF = QtGui.QAction(MainWindow)
        self.openASDF.setObjectName(_fromUtf8("openASDF"))
        self.menuFile.addAction(self.openASDF)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "SD5 Sextant", None))
        self.select_file_button.setText(_translate("MainWindow", "Open File", None))
        self.continuous_check_box.setText(_translate("MainWindow", "Continuous Dataset", None))
        ...
        self.openASDF.setText(_translate("MainWindow", "Open", None))
